...
gsize
_hbgi_g_type_tag_size (GITypeTag type_tag)
{
    gsize size = 0;
    ...
    switch (type_tag) {
        ...
        case GI_TYPE_TAG_ERROR:
            ...
            hb_errRT_BASE_SubstR(EG_DATATYPE, 50042, "Unable to know the size", "hbgi", HB_ERR_ARGS_BASEPARAMS);
            break;
    }
    ...
    switch (type_tag) {
        ...
        case GI_TYPE_TAG_UNICHAR:
            if (g_type_info_is_pointer (type_info)) {
                ...
                size = _hbgi_g_type_tag_size (type_tag);
                g_assert (size > 0);
            }
            break;
        case GI_TYPE_TAG_INTERFACE:
