...
HARBOUR_HOME="$HOME/harbour-core"
HARBOUR_PLAT="linux/gcc"
HBMK2="$HARBOUR_HOME/bin/$HARBOUR_PLAT/hbmk2 -q0 -w1 -es2 -debug -optim- -cflag=-Wno-missing-field-initializers -trace"
...
#SOURCE_FLAGS="$(pkg-config --cflags --libs gtksourceview-3.0)"
...
cd ../gobject
$HBMK2 -hblib -o../hbgobject -I../hb -I../gi $HBGOBJECT_FLAGS $SOURCE_FLAGS $HBGOBJECT_SOURCES || exit $?
...
$HBMK2 -L. -lhbgihb -lhbgobject -lhbgi -gtcgi $HBGI_FLAGS $SOURCE_FLAGS test.prg || exit $?
